...
//+ (UIButton *)dn_createButtonWithTitle:(NSString *)title titleFont:(CGFloat)titleFont titleColor:(UIColor *)titleColor {
//    
//    return [UIButton dn_createButtonWithTitle:title titleFont:titleFont titleColor:titleColor normalImage:nil selectImage:nil backgroundColor:nil];
//}
//
//+ (UIButton *)dn_createButtonWithTitle:(NSString *)title titleFont:(CGFloat)titleFont titleColor:(UIColor *)titleColor normalImage:(NSString *)normalImage selectImage:(NSString *)selectImage backgroundColor:(UIColor *)backgroundColor {
//    
...
//    [button setImage:IMAGE(selectImage) forState:UIControlStateSelected];
